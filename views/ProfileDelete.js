...
const ProfileDelete = ({navigation}) => {
    ...
    <StyledContainer>
      <InnerContainer>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <CustomHeader label="Delete Profile"/>
        </TouchableOpacity>
        ...
        <DeleteWarning>
          We will immediately delete all of your{" "}
          <WarningB>transaction</WarningB>, along with all of your{" "}
          <WarningB>profile detail</WarningB>.
        </DeleteWarning>
        <Formik
                  ...
                  <StyledFormArea>
                    ...
                    {!isSubmitting && (
                      <StyledButton
                        ...
                        style={{ backgroundColor: COLOR.expense }}
                      >
